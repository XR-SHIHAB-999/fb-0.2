...
def logo_menu():
 ...
 banner = f''' 
          \033[1;92m  
     _______. __    __   __   __    __       ___      .______   
    /       ||  |  |  | |  | |  |  |  |     /   \     |   _  \  
   |   (----`|  |__|  | |  | |  |__|  |    /  ^  \    |  |_)  | 
    \   \    |   __   | |  | |   __   |   /  /_\  \   |   _  <  
.----)   |   |  |  |  | |  | |  |  |  |  /  _____  \  |  |_)  | 
|_______/    |__|  |__| |__| |__|  |__| /__/     \__\ |______/  
		   ...
		   \033[1;92m{"SHIHAB PARVEJ BRO😊"}
	       \033[1;91m["WELCOME TO SHIHAB WORLD🌍"]

\033[1;92m WELCOME TO  Shihab parvej's TOOLS:>   '''
 cetak(nel(banner,title=f'{P2} {H2}[ Brand BRO]',subtitle_align='left',padding=1,style='blue'))
	
###----------[ MENU LOGIN ]----------###	
def login():
	os.system("clear")
	cetak(nel(f'   {H2} 	 WELCOME TO SHIHAB SHARE WORLD \n\n      {H2}       [ GITHUB :XR-SHIHAB-999]',title=f'{P2} {H2}[ {OT} WELCOME SIRðŸ’¥ {H2}]',width=54,padding=(1,4),style='blue'))
